...
import { TrendingUp, TrendingDown, DollarSign, Briefcase, Building2, BarChart3 } from "lucide-react";
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Platform fee analytics and top company spending</p>
        </div>
          ...
          {!stats?.topCompanies || stats.topCompanies.length === 0 ? (
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                ...
                <tbody>
                  {(stats.topCompanies as any[]).map((c, i) => (
