...
import { Building2, Calendar, Settings, Plus } from "lucide-react";
import { useState } from "react";
import { ManageCompanyDialog, CreateCompanyDialog } from "@/components/admin/AdminCompanyDialogs";
    ...
    <div className="space-y-6">
      ...
      {managingCompany && (
        <ManageCompanyDialog
          ...
          onSaved={() => { setManagingCompany(null); refetch(); }}
        />
      )}
    </div>
  );
